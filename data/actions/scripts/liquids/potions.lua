...
local potions = {
	...
	[7588] = {health = {200, 300}, level = 50, flask = 7634,
			description = "Only players of level 50 or above may drink this fluid."},

	[7589] = {mana = {100, 200}, level = 50, flask = 7634,
			description = "Only players of level 50 or above may drink this fluid."},

	[7590] = {mana = {200, 300}, level = 80, flask = 7635,
			description = "Only players level 80 or above may drink this fluid."},

	[7591] = {health = {350, 450}, level = 80, flask = 7635,
			description = "Only players of level 80 or above may drink this fluid."},

	[7618] = {health = {120, 180}, flask = 7636},
	[7620] = {mana = {50, 100}, flask = 7636},
