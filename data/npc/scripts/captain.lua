...
function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, 'captain') or msgcontains(msg, 'guard')) then
				...
				selfSay('Ahh the renegades! They are our most dangerous enemy. In this region there isnt Orc, but men can be evil as well. Maybe you may want to work with us in some {mission}? ', cid)
