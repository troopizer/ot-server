...
function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, 'mission') or msgcontains(msg, 'dunedain') or msgcontains(msg, 'ranger')) then
			...
			elseif(getPlayerStorageValue(cid,2046) == 20) then
					selfSay('You are quite strong, I have anothe {mission} for you (you received 7000 exp and 500 gp) ', cid)
			...
			elseif(getPlayerStorageValue(cid,2047) == 0 and getPlayerItemCount(cid,5924) >= 5) then
					...
					selfSay('Great! Choose one of this abilities: {strong strike}, {twisting slash}, {shield wall} and {sharp aim}. (you received 10000 exp) ', cid)
			...
			elseif(getPlayerStorageValue(cid,2050) == 2) then
					selfSay('Nice done, it looks like you had to do a long journey. Any way I will teach you {Forced March}.(You have received 7000 exp)', cid)
			...
			elseif(getPlayerStorageValue(cid,2053) == 1) then
					selfSay('Nice done! As your payment take this platinum amulet symbol of the dunedain, you have worked as one of us.(you received 15000 exp and a platinum amulet) ', cid)
