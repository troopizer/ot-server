...
function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, 'mission')) then
			...
			elseif(getPlayerStorageValue(cid,2120) == 50) then
					selfSay('Well done. (You received 200 gp and 2000 exp)', cid)
			...
			elseif(getPlayerStorageValue(cid,2121) == 50) then
					selfSay('Well done. (You received 300 gp and 5000 exp)', cid)
			...
			elseif(getPlayerStorageValue(cid,2122) == 100) then
					selfSay('Well done. (You received 3000 gp and 100000 exp)', cid)
