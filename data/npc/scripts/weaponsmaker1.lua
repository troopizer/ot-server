...
local random_texts = {
	'The renegades make so hard to get iron these days.',
	'Nothing like a sharp blade, a balanced mace and a straight arrow...',
	'buuff..turn off that furnace for a while.. Father please.'
}
